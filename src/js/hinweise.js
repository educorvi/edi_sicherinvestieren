...
//    Begrüßung
    begruessung: {
        sichtbar: true,
        title: "Begrüßung",
        text: "Sie planen die Investition in eine neue Maschine oder Anlage? Neben vielen anderen Aspekten spielen dabei auch die Sicherheit und die Gesundheit Ihrer Beschäftigten eine wichtige Rolle. Die BG ETEM unterstützt Sie mit dieser App bei der Auswahl sicherer Maschinen. Das hilft Ihnen auch, teure Nachrüstungen zu vermeiden. Bitte beachten Sie, dass diese Anwendung eine vollständige Bewertung der konkreten Gefährdungen der Maschine am vorgesehenen Einsatzort nicht ersetzen kann.\n" +
            "Wählen Sie aus, welchen Maschinentyp Sie bewerten möchten."
    },

//    Rechtliche Einschränkung vor Auswertung
    rechtlicheEinschraenkung: {
        sichtbar: true,
        title: "Rechtlicher Hinweis",
        text: "Die BG ETEM versucht nach besten Kräften, die Zuverlässigkeit und Fehlerfreiheit der präsentierten Fragen und Hinweise sicherzustellen. Aufgrund der weltweit üblichen Haftung für Texte und Produkte machen wir auf Folgendes aufmerksam:\n" +
